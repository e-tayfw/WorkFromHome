...
const Schedule = () => {
  ...
  return (
    <div data-testid="schedule-component" className="flex flex-col w-full">
      ...
      <div className="max-w-8xl w-full px-[16px] md:px-[128px] pt-[60px] pb-[30px] md:pt-[50px] flex justify-center items-center">
