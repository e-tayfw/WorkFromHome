...
const Apply: React.FC = () => {
        ...
        html: `
          ...
          <div style="display: flex; justify-content: center;">
            <div style="text-align: left; display: inline-block;">
              ...
              <p>Arrangement: ${formatArrangement(
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      const response = await axios.post(
        "https://54.251.20.155.nip.io/api/request",
        submitData,
        {
          headers: {
            "Content-Type": "application/json",
          ...
          html: `
            ...
            <div style="display: flex; justify-content: center;">
              <div style="text-align: left; display: inline-block;">
                ...
                <p>Existing Arrangement: ${formatExistingArrangements(
                  responseData.existing
                )}</p>
                <p>Requested Arrangement: ${formatArrangement(
        ...
        <Tabs>
          ...
          <TabPanel>
            <div>
              ...
              <div
                className="flex items-center text-left bg-gray-50 border border-gray-300 text-primary text-sm font-light mt-4 h-8 px-2 py-3 rounded"
                role="alert"
              >
                <svg
            ...
            <div>
              ...
              <div className="mt-4">
                <Submit
                  ...
                  isDisabled={!isRecurringFormValid}
                />
              </div>
            </div>
          </TabPanel>
