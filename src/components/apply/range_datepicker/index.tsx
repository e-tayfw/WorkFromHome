      ...
      import("flowbite-datepicker")
        .then((module) => {
          ...
          if (startDateRef.current) {
            ...
            startDateRef.current.addEventListener(
              "changeDate",
              (event: Event) => {
                ...
                if (target && target.value) {
                  ...
                  if (endPicker) {
                    ...
                    if (
                      ...
                      new Date(selectedDateRange.end) <= new Date(target.value)
                    ) {
          ...
          if (endDateRef.current) {
            const initialMinDate = selectedDateRange.start
            ...
            endDateRef.current.addEventListener(
              "changeDate",
              (event: Event) => {
                const target = event.target as HTMLInputElement;
                if (target && target.value) {
